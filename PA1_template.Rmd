...
`r totalsteps_median`.  Below is a histogram of the total steps per day.  
...
There were a total of `r missingnum` missing values.  I imputed by replacing NAs with the average value for that 5-minute interval for all days.  The mean total steps per day after imputation is `r totalstepsimp_mean` and the median total steps per day after imputation is `r totalstepsimp_median`.  Below is a histogram of the total steps per day after imputation.  
